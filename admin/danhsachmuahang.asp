            ...
            <nav aria-label="Page Navigation">
                <ul class="pagination pagination-sm justify-content-center my-5">
                    ...
                    'kiem tra trang hien tai co >=2
                        if(Clng(page)>=2) then
                    %>
                        <li class="page-item"><a class="page-link" href="danhsachmuahang.asp?page=<%=Clng(page)-1%>">Previous</a></li>
                    <%    
                        end if 
                        for i = 1 to range
                    %>
                    ...
                    %>
                        <li class="page-item"><a class="page-link" href="danhsachmuahang.asp?page=<%=Clng(page)+1%>">Next</a></li>
                    <%
                        end if    
                    end if
                    %>
